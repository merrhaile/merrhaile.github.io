...
const findSubtree = myExports.findSubtree;
...
describe("finds a subtree with target as a root", function () {
            /**
         * 
         * @param {String} value is a string
         * @returns {Undegined} it is a constructor fucntion
         */
    ...
    it("prints the subtree", function () {
        assert.deepEqual(findSubtree(abe, "Homer"),  {value: "Homer", descendents: 
        [{ value: "Bart", descendents: [] },{ value: "Lisa", descendents: [] },
        { value: "Maggie", descendents: [] }]});
     });

    it("prints a subtree", function () {
        assert.deepEqual(findSubtree(abe, "Lisa"), null);
    });
    it("prints a subtree", function () {
        assert.deepEqual(findSubtree(abe, "Bart"), null);
    });
});