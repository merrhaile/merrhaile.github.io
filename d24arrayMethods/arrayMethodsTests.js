...
// const userNames = myExports.userNames;
// const userMapped = myExports.userMapped;
...
//Create and array of names from an arry of objects
  describe("Array of names", function () {
    it("returns array of names", function () {
        let john = { name: "John", age: 25 };
        let pete = { name: "Pete", age: 30 };
        let mary = { name: "Mary", age: 28 };
        let users = [ john, pete, mary ];
        let names = userNames(users);
        assert.deepEqual(names, ["John", "Pete", "Mary"]);
    });
});

// create an objects with ID and fullName
describe("userMapped", function () {
    let john = { name: "John", surname: "Smith", id: 1 };
    let pete = { name: "Pete", surname: "Hunt", id: 2 };
    let mary = { name: "Mary", surname: "Key", id: 3 };
    let users = [ john, pete, mary ];
    
    it("creates objects with ID and fullName", function () {
        assert.deepEqual(userMapped(users), [
...
// create an array of objects sorted by age
describe("sortByAge", function () {
    let john = { name: "John", age: 25 };
    let pete = { name: "Pete", age: 30 };
    let mary = { name: "Mary", age: 28 };
    let arr = [ pete, john, mary ];
    it("sorts the objects by age", function () {
        assert.deepEqual(sortByAge(arr), [john, mary, pete]);
    });
});

// create a function that returns the average of ages of objects
describe("getAverageAge", function () {
    let john = { name: "John", age: 25 };
    let pete = { name: "Pete", age: 30 };
    let mary = { name: "Mary", age: 29 };
    let arr = [ john, pete, mary ];
    it("returns an average age", function () {
