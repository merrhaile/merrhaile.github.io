...
// const averageNumbers = myExports.averageNumbers;
// const maxAge = myExports.maxAge;
// const evenAgeAverage = myExports.evenAgeAverage;
// const oddAgeAverage = myExports.oddAgeAverage;
// const findAgeOver10 = myExports.findAgeOver10;
// const includesAgeOver10 = myExports.includesAgeOver10;
...
describe("filter practice", function () {
    ...
    it("find age over 10", function (){
        assert.strictEqual(findAgeOver10(peopleArray),{ name: "Sam", age: 15 } );
    });

    it("includes age over 10", function (){
        assert.strictEqual(includesAgeOver10(peopleArray),true);
    });
...
describe("reduce practice", function () {
    ...
    it("Average of array elements", function (){
        assert.strictEqual(averageNumbers(numArray), 52.75);
    });

    it("Maximum number", function (){
        assert.strictEqual(maxNumbers(numArray), 300);
    });

    it("Maximum Age", function (){
        assert.strictEqual(maxAge(peopleArray), 80);
    });

});

describe("Chain of reduce, filter, map practice", function () {
    beforeEach(function () {
        numArray = [5, 0, 7, 77, -20, 300, 51, 2];
        peopleArray = [{ name: "Sam", age: 15 }, { name: "William", age: 6 }, { name: "Lucy", age: 13 }, { name: "Barney", age: 80 }];
    });
    ...
    it("Average of even ages", function (){
        assert.strictEqual(evenAgeAverage(peopleArray), 43);
    });

    it("Average of odd ages", function (){
        assert.strictEqual(oddAgeAverage(peopleArray), 14);
    });
